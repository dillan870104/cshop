...
<div id="container">
    ...
    <div id="sidebody">
      <div class="car">
        ...
        <form name="salecorrect" method="post" action="admin_alter.jsp">
          <tr class="car_tr">
            <td  class="car_td"><img src="pic/men/longt3.jfif" width="310px" height="330px"></td> 
            <td  class="car_td">
            <ul> 
              <li>商品編號 :  <input type="text" name="pro_no"> </li>                                           
              <li>更改後名稱 : <input type="text" name="pro_name">  </li>  
              <li>更改後價錢 : <input type="text" name="pro_cost"> </li>
              <li>更改後庫存 : <input type="text" name="pro_amount"> </li>
              <li>更改供應商 : <input type="text" name="pro_supplier"> </li>
              <li>性別 : <input type="text" name="pro_sex"> </li>
