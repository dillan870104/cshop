...
<div id="container">
    ...
    <div id="sidebody">
      ...
      <div class="item3">
        <table>
          <caption style="font-weight:bold"><span style="font-size:28px">漸層藍襯衫</span></caption>
          <tr>
  ...
  <section class="mes-send">
    <form method="post" action="">
         <div class="form-group">
            ...
            <textarea id="user_mes" name="user_mes" disabled>你還沒登入</textarea>
         </div>
      
         <input type="submit" value="送 出" disabled>&nbsp;<input type="reset" value="重 填" disabled>
