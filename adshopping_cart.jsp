...
<div id="container">
    ...
    <a href="adcar_check.jsp"><input type="button" name="check" value="確認" class="car_btn"></a>
    <a href="adindex.jsp"><input type="button" name="continue" value="繼續購物" class="car_btn"></a>
