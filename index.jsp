...
<div id="container">
    ...
    <div id="sidebody">
     <form action="b4 1.jsp" method="get" accept-charset="utf-8">
      ...
      <div class="box">
        <a href="b4 1.jsp" ><button name="id" value="001"><img src="pic/men/longt3.jfif" class="box_pic" ></button></a>
        <p>漸層藍襯衫</p>
      </div>
      <div class="box">
        <a href="b4 1.jsp" ><button name="id" value="017"><img src="pic/women/glongt3.jfif" class="box_pic"></button></a>
        <p>長袖薄T-女</p>
      </div>
      <div class="box">
        <a href="b4 1.jsp"><button name="id" value="019"><img src="pic/men/pants3.jfif" class="box_pic" name="id" value="019"></button></a>
        <p>白棉褲</p>
      </div>
      <div class="box">
        <a href="b4 1.jsp"><button name="id" value="020"><img src="pic/women/gpants2.jpg" class="box_pic"></button></a>
        <p>牛仔長褲-女</p>
      </div>
      <div class="box">
        <a href="b4 1.jsp"><button name="id" value="008"><img src="pic/men/shortt2.jfif" class="box_pic"></button></a>
        <p>印花橘短T</p>
      </div><br>
    ...
    <form action="b4 1.jsp" method="get" accept-charset="utf-8">
      ...
      <div class="box">
        <a href="b4 1.jsp"><button name="id" value="015"><img src="pic/women/glongt1.jfif" class="box_pic"></button></a>
        <p>大學T-女</p>
      </div>
      <div class="box">
        <a href="b4 1.jsp"><button name="id" value="014"><img src="pic/men/longt2.jfif" class="box_pic"></button></a>
        <p>格子毛衣</p>
      </div>
      <div class="box">
        <a href="b4 1.jsp"><button name="id" value="018"><img src="pic/men/pants1.jfif" class="box_pic"></button></a>
        <p>牛仔長褲</p>
      </div>
      <div class="box">
        <a href="b4 1.jsp"><button name="id" value="024"><img src="pic/women/gpants4.jfif" class="box_pic"></button></a>
        <p>休閒短褲-(褐)女</p>
      </div>
      <div class="box">
        <a href="b4 1.jsp"><button name="id" value="007"><img src="pic/men/shortt1.jfif" class="box_pic"></button></a>
        <p>印花白短T</p>
      </div><br>
    </form>
...
<!--促銷商品-->
    <form action="b4 1.jsp" method="get" accept-charset="utf-8">
      ...
      <div class="box">
        <a href="b4 1.jsp"><button name="id" value="002"><img src="pic/men/longt4.jfif" class="box_pic"></button></a>
        <p>圓領襯衫</p>
      </div>
      <div class="box">
        <a href="b4 1.jsp"><button name="id" value="009"><img src="pic/women/gshortt1.jpg" class="box_pic"></button></a>
        <p>卡通印花短T-女</p>
      </div>
      <div class="box">
        <a href="b4 1.jsp"><button name="id" value="012"><img src="pic/men/longt1.jpg" class="box_pic"></button></a>
        <p>白大學T</p>
      </div>
      <div class="box">
        <a href="b4 1.jsp"><button name="id" value="016"><img src="pic/women/glongt2.jpg" class="box_pic"></button></a>
        <p>高領毛衣-女</p>
      </div>
      <div class="box">
        <a href="b4 1.jsp"><button name="id" value="021"><img src="pic/women/gpants3.jfif" class="box_pic"></button></a>
        <p>灰色丹寧褲-女</p>
      </div>
    </form>
