...
<div id="container">
    ...
    <div id="sidebody">
      <div class="item">
        <a href="sales.jsp" style="text-decoration:none;">所有商品 </a> > <a href="menc.jsp" style="text-decoration:none;">男裝</a> > 棉質白素T
      </div>
      <div class="item2">
        <img id="myImg" src="pic/men/shortt3.jfif" title="點我放大" style="width:100%;max-width:400px">
      ...
      <div class="item3">
        <table>
          <caption style="font-weight:bold"><span style="font-size:28px">棉質白素T</span></caption>
          <tr>
