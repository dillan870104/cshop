...
<div id="container">
    ...
    <div id="sidebody">
      <div class="item">
        <a href="sales.jsp" style="text-decoration:none;">所有商品 </a> > <a href="womenc.jsp" style="text-decoration:none;">女裝</a> > 牛仔長褲-女
      </div>
      <div class="item2">
        <img id="myImg" src="pic/women/gpants2.jpg" title="點我放大" style="width:100%;max-width:400px">
      ...
      <div class="item3">
        <table>
          <caption style="font-weight:bold"><span style="font-size:28px">牛仔長褲-女</span></caption>
          <tr>
          ...
          <tr>
            ...
            <td>&nbsp;商品介紹:&nbsp;</td>
            <td>產地:台灣<br>棉87%、聚酯纖維9%、彈性纖維4%</td>
          </tr>
          <tr>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
