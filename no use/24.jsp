...
<div id="container">
    ...
    <div id="sidebody">
      <div class="item">
        <a href="sales.jsp" style="text-decoration:none;">所有商品 </a> > <a href="womenc.jsp" style="text-decoration:none;">女裝</a> > 休閒短褲-(褐)女
      </div>
      <div class="item2">
        <img id="myImg" src="pic/women/gpants4.jfif" title="點我放大" style="width:100%;max-width:400px">
      ...
      <div class="item3">
        <table>
          <caption style="font-weight:bold"><span style="font-size:28px">休閒短褲-(褐)女</span></caption>
          <tr>
