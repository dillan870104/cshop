...
<div id="container">
    ...
    <div id="sidebody">
      <div class="item">
        <a href="sales.jsp" style="text-decoration:none;">所有商品 </a> > <a href="womenc.jsp" style="text-decoration:none;">女裝</a> > 粉素T-女
      </div>
      <div class="item2">
        <img id="myImg" src="pic/women/gshortt3.jfif" title="點我放大" style="width:100%;max-width:400px">
      ...
      <div class="item3">
        <table>
          <caption style="font-weight:bold"><span style="font-size:28px">粉素T-女</span></caption>
          <tr>
