...
<div id="container">
    ...
    <div id="sidebody">
      ...
      <div class="salesbox">
        <a href="1.jsp"><button name="id" value="001"><img src="pic/men/longt3.jfif" class="salesbox_pic"></button></a>
        <p>漸層藍襯衫</p>
      </div>
      <div class="salesbox">
      ...
      <div class="salesbox">
        <a href="1.jsp"><button name="id" value="018"><img src="pic/men/pants1.jfif" class="salesbox_pic"></button></a>
        <p>牛仔長褲</p>
      </div>
      <div class="salesbox">
